...
const EditProfile = ({
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      bands: loading || !profile.bio ? "" : profile.bands,
      education: loading || !profile.bio ? "" : profile.education,
      years_playing: loading || !profile.bio ? "" : profile.years_playing,
      years_active: loading || !profile.bio ? "" : profile.years_active,
